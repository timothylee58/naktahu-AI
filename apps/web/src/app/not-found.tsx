...
export default function NotFound() {
  ...
  return (
    <div className={`flex min-h-screen flex-col items-center justify-center gap-4 px-4 text-center ${pageClass}`}>
      <p className="text-5xl font-bold text-[#2563EB]" aria-hidden>
        404
      </p>
      ...
      <Link
        href="/"
        className="mt-2 inline-flex items-center gap-2 rounded-full bg-[#2563EB] px-6 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-500 locale-nowrap"
      >
        {t('not_found.cta')}
      </Link>
    </div>
