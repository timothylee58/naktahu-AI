  ...
  return (
    <>
      ...
      <Folder name="Showcase">
        <Composition id="Showcase-bm-16x9" component={Showcase} durationInFrames={1140} fps={30} width={1920} height={1080} defaultProps={{ lang: "bm" }} />
        <Composition id="Showcase-bm-9x16" component={Showcase} durationInFrames={1140} fps={30} width={1080} height={1920} defaultProps={{ lang: "bm" }} />
        <Composition id="Showcase-en-16x9" component={Showcase} durationInFrames={1140} fps={30} width={1920} height={1080} defaultProps={{ lang: "en" }} />
        <Composition id="Showcase-en-9x16" component={Showcase} durationInFrames={1140} fps={30} width={1080} height={1920} defaultProps={{ lang: "en" }} />
        <Composition id="Showcase-zh-16x9" component={Showcase} durationInFrames={1140} fps={30} width={1920} height={1080} defaultProps={{ lang: "zh" }} />
        <Composition id="Showcase-zh-9x16" component={Showcase} durationInFrames={1140} fps={30} width={1080} height={1920} defaultProps={{ lang: "zh" }} />
      </Folder>
